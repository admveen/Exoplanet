...
full_transformed_data['weak_secondary_stat'] = (full_transformed_data.p_secondary >= 0.17).astype('int').replace({0: '< 0.17', 1: '> 0.17' })
sns.catplot(x = 'target_label', data = full_transformed_data, col = 'weak_secondary_stat', kind = 'count', palette = 'tab10')
plt.tight_layout()
...
full_transformed_data['evenodd_stat_cond'] = (full_transformed_data.even_odd_stat >= 0.1).astype('int').replace({0: '< 0.1', 1: '> 0.1' })
sns.catplot(x = 'target_label', data = full_transformed_data, col = 'evenodd_stat_cond', kind = 'count', palette = "tab10")
